        ...
        <div>
          <div className="certificate-container">
            <div className="inside">
              <img
                className="pdf-img"
                src="/src/assets/Quizical-img/Group 4821.png"
                alt=""
              />{" "}
              <h1 className="cv-header"> Certificate of Completion </h1>
              <p>This is to certify that</p>
              <h2 id="userName" className="cv-header2">{props.name}</h2>
              <p className="cv-text">has successfully completed the general knowledge quiz.</p>
            ...
            <div className="pdf-img--container">
                <img className="pdf-img" src="/src/assets/Quizical-img/completion.svg" alt="completion-image" />
            </div>
          </div>
        </div>
      </div>
